    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center">
          <Button variant="ghost" size="icon" onClick={() => router.push("/library")} className="mr-2">
        ...
        <Card className="mt-6">
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => router.push("/library")}>Return to Library</Button>
          </CardContent>
        </Card>
      </div>
    )
            ...
            <TabsContent value="ar" className="mt-0">
              <div className="aspect-video overflow-hidden rounded-lg bg-black">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Button className="bg-purple-600 hover:bg-purple-700" onClick={() => router.push(`/ar?qrData=${id}`)}>
                    View in AR
                  </Button>
                </div>
              </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2">
              {content.languages.map((language, index) => (
                <div key={index} className="rounded-full bg-purple-100 px-3 py-1 text-sm text-purple-800">
                  {language}
                </div>
              ))}
            </div>
        ...
        <div>
          ...
          <div className="mt-6">
            <Button
              ...
              onClick={() => router.push(`/ar?qrData=${id}`)}
            >
              View in AR
            </Button>
          </div>
